...
const BenefitSection: React.FC<Props> = ({ benefit, imageAtRight }: Props) => {
    ...
    const title = isEn && benefit.titleEn ? benefit.titleEn : benefit.title;
    const description = isEn && benefit.descriptionEn ? benefit.descriptionEn : benefit.description;
            ...
            >
                ...
                <div className={clsx("mt-5 lg:mt-0", { "lg:order-2": imageAtRight })}>
                    <div className={clsx("w-fit flex", { "justify-start": imageAtRight, "justify-end": !imageAtRight })}>
                        <Image src={imageSrc} alt={title} width={307} height={610} quality={100} className="lg:ml-0" />
                    </div>
                </div>
            </motion.div>
        </section>
